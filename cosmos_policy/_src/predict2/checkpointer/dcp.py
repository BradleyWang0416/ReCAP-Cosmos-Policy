...
from cosmos_policy._src.imaginaire.checkpointer.base import AbstractCheckpointer
from cosmos_policy._src.imaginaire.checkpointer.s3_filesystem import S3StorageReader, S3StorageWriter
...
class ModelWrapper(Stateful):
    ...
    def __init__(self, model: Union[nn.Module, List[nn.Module]], load_ema_to_reg: bool = False):
        ...
        if self.load_ema_to_reg:
            ...
            from cosmos_policy._src.predict2.models.text2world_model import DiffusionModel as predict2_DiffusionModel
            ...
            from cosmos_policy._src.predict2.models.text2world_wan2pt1_model import (
